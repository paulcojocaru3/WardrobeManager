...
// kept in one place so the two handlers don't duplicate the archive/delete rules and DTO mapping.
internal static class PlannerEventProjection
{
    ...
    private static EventItineraryDto ToItineraryDto(EventItinerary i) => new()
    {
        Id = i.Id,
        OutfitId = i.OutfitId,
        Date = i.Date,
